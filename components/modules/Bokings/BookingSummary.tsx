    ...
    <section className="content-container section-spacing">
      <Card className="glass-card overflow-hidden">
        <CardHeader className="bg-linear-to-br from-blue-600 via-cyan-600 to-indigo-600 text-white">
          <div>
            <Badge className="mb-2 ai-glow">
              <Sparkles className="mr-1 size-3.5" />
              Booking Summary
            </Badge>
            <CardTitle className="h2 text-white">Reserve your session</CardTitle>
            <CardDescription className="muted text-white/80">
        ...
        <CardContent className="space-y-4 p-5">
          <div className="glass-card p-4">
            ...
            <p className="text-base muted dark:text-slate-300">{expertTitle || "Consultation specialist"}</p>
          </div>

          <div className="section-grid sm:grid-cols-2 gap-3">
            <div className="glass-card p-3">
              <div className="mb-1 flex items-center gap-2 muted">
              ...
              <div className="min-w-0">
                ...
                {appliedCoupon ? (
                  <div className="mt-1 flex flex-wrap items-baseline gap-2">
                    ...
                    <p className="text-sm font-medium muted line-through dark:text-slate-400">
          ...
          {!isLoggedIn ? (
            <div className="glass-card border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200">
              Sign in with a <strong>client</strong> account to continue booking.
            </div>
          ) : !isClient ? (
            <div className="glass-card border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-800 dark:border-sky-500/30 dark:bg-sky-500/10 dark:text-sky-200">
              Booking is currently available for <strong>client accounts</strong> only.
            </div>
          ) : (
            <div className="glass-card border-blue-100 bg-blue-50/60 px-4 py-3 text-sm text-blue-800 dark:border-cyan-500/30 dark:bg-cyan-500/10 dark:text-cyan-100">
