...
const DashboardSidebarContent = ({dashboardHome, navItems, userInfo} : DashboardSidebarContentProps) => {
  ...
  return (
    <aside className="hidden lg:flex h-full w-64 flex-col border-r bg-card overflow-y-auto glass-card">
      {/* Logo / Brand */}
      <div className="flex h-20 items-end px-6 pb-4 border-b">
        <Link href={dashboardHome}>
          <span className="text-xl font-bold hero-gradient pt-4">HireGPT</span>
        </Link>
      </div>
    ...
    >
      ...
      <div className="border-t px-3 py-4">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-full ai-glow flex items-center justify-center shrink-0">
