...
export default function IndustryTicker({ industries }: IndustryTickerProps) {
  ...
  return (
    <section className="page-container section-spacing">
      <div className="glass-card section-padding relative overflow-hidden">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[linear-gradient(122deg,rgba(255,255,255,0.4),rgba(255,255,255,0.08)_45%,rgba(59,130,246,0.08)_100%)] dark:bg-[linear-gradient(122deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02)_45%,rgba(34,211,238,0.07)_100%)] rounded-xl"
        />

        <div className="relative mb-6 section-grid xl:flex-row xl:items-end xl:justify-between">
          <div className="space-y-3">
            <Badge variant="secondary" className="mb-2 bg-blue-100 text-blue-700 dark:bg-blue-500/10 dark:text-blue-200">
              Industry focus
            </Badge>
            <h2 className="h2">Explore the sectors where teams need sharper guidance most</h2>
            <p className="max-w-2xl muted md:text-base">
          ...
          <Button
            asChild
            variant="outline"
            className="h-11 w-full rounded-xl border-blue-200 bg-white/80 px-5 text-sm font-medium text-slate-900 shadow-sm hover:bg-blue-50 sm:w-auto dark:border-white/15 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
          >
        ...
        {tickerItems.length > 0 ? (
          <div className="relative overflow-hidden rounded-xl border border-blue-100 bg-linear-to-r from-slate-950 via-blue-950 to-slate-950 px-2 py-3 shadow-lg shadow-blue-500/10 sm:rounded-2xl sm:py-4 dark:rounded-4xl">
          ...
          <Card>
            <CardContent className="py-10 text-center muted">
